...
namespace WebApp.Pages
{
    ...
    public class Player2AttackModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            GameUI.ObjectHolderForWebApp.GameBoard.Player2Turn();
            ...
            for (int i = 0; i < ObjectHolderForWebApp.GameBoard.TableDimension; i++)
            {
                ...
                {
                    if (ObjectHolderForWebApp.GameBoard.Player1Board1[i][j] == BoardSquareState.Ship)
                    {
            ...
            return RedirectToPage("/Player2AttackResult");
